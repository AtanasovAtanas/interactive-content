...
After filling this simple phonebook, upon receiving the **command "search"**, your program should be able to perform a search of a contact by name and print the details in format `{name} -> {number}`. 
