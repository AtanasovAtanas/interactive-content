[slide hideTitle]
# Problem: Division
[code-task title="Division" taskId="python-fund-02-Basic Syntax-Exercise-problem-2" executionType="tests-execution" executionStrategy="python-code" requiresInput]
