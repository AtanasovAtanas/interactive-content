...
[code-task title="Array Rotation" taskId="python-fund-08-Arrays-Exercise-problem-4" executionType="tests-execution" executionStrategy="python-code" requiresInput]
